...
// We can't read process.env on the client — pass it via a public env var
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-3xl border border-slate-100 shadow-card p-8 text-center">
          ...
          {GOOGLE_CONFIGURED ? (
            ...
            <div className="p-4 bg-slate-50 border border-slate-200 rounded-2xl text-sm text-slate-600">
              <p className="font-semibold text-slate-700 mb-1">Customer sign-in coming soon</p>
              <p className="text-xs text-slate-500">Google sign-in will be available once configured. For admin access, visit <Link href="/admin/login" className="text-brand-600 underline">/admin/login</Link>.</p>
            </div>
          )}
